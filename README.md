...
<head>
  ...
  <meta name="description" content="Krishen Banerjee — student, soccer fan, and aspiring developer."/>
...
<body>
  ...
  <header class="site-header">
    <div class="container header-inner">
      <div>
        <h1>Krishen Banerjee</h1>
        <p class="subtitle">Soccer ⚽ · Student · Learning to code</p>
      </div>
      <nav class="social">
        <a href="https://github.com/krishen28" target="_blank" rel="noopener">GitHub</a>
      </nav>
    </div>
  </header>
  ...
  <main class="container">
    ...
    <!-- Keep Version 1 (original) visibly preserved -->
    <section id="version-one" class="card">
      <h2>Version 1 (original)</h2>
      <p>This area preserves the original structure and content from your first version. Keep it as-is, or edit here to reflect your original text.</p>
      <div class="original-blob">
        <!-- Put any original content you want to keep here --><!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width,initial-scale=1" />
